...
| 016 | **Epic: agentic demo studio** — `@objectcore/demo` engine (`deriveDemo` seam + the deterministic de-slop/evidence/live-safety gate + curated demo archetypes) and the `demo-studio` plugin; makes "transparency over spectacle" a gate rather than a prose aspiration | P2 | L (P0–P6) | Stage 1 patterns + plan 012/014 shapes | **IN PROGRESS** (branch `feat/016-demo-studio`) — research digest `notes/016-demo-studio-research.md`; forge gap report `notes/016-demo-studio-forge-gaps.md` (L1) |
